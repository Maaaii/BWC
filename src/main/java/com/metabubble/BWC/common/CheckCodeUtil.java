...
public class CheckCodeUtil {
     ...
     * @throws IOException
     */
    public static String outputVerifyImage(int wight, int height, File outputFile, int verifySize) throws IOException {
        String verifyCode = generateVerifyCode(verifySize);
        outputImage(wight, height, outputFile, verifyCode);
        return verifyCode;
    }
